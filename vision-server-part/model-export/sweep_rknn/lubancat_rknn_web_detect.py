...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="LubanCat web realtime clutter classification by RKNN")
    parser.add_argument("--weights", required=True, help="path to RKNN model dir or file")
    parser.add_argument("--camera", type=int, default=0, help="camera index")
    parser.add_argument("--port", type=int, default=5006, help="web port")
...
def index():
    ...
    <html>
        <head>
            <meta charset="utf-8">
            <title>LubanCat RKNN Detect</title>
            <style>
            ...
            <script>
                ...
                async function refreshStatus() {
                    ...
                    document.getElementById('tip').textContent = 'RKNN 推理前先裁剪 ROI';
        ...
        <body>
            <div class="wrap">
                <div class="title">鲁班猫 RKNN 床底杂物检测</div>
                <div class="panel">
